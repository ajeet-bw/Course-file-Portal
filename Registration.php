...
<fieldset> 
<!-- Form Name -->
<legend><center><h2><b>Faculty Registration Form</b></h2></center></legend><br>
...
<div class="form-group">
  ...
  <label class="col-md-4 control-label"></label>
    ...
    <select name="Department" class="form-control selectpicker">
      ...
      <option >Machenical Engeering</option>
...
<div class="form-group">
  ...
  <div class="col-md-4"><br>
      ...
      <div>
          <input type="submit" class="btn btn-info"value="Submit"style="color:black" name="register">
          <input type="submit" class="btn btn-info" value="Reset"style="color:black" name="reset">
      </div>
  </div>
  <div>
  <p>
  Already a member?<a href ="chandan.php">Sign in</a>
  </p>
  </div>
</div>
</fieldset>
